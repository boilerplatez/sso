<html>
<head>
    <link rel="stylesheet" href="/src/external/components/webmodules-bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/src/external/components/webmodules-bootstrap/css/bootstrap-theme.min.css">
</head>
<body>
<div class="container">
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div style="padding-top:30px" class="panel-body">
                ...
                <form id="loginform" class="form-horizontal" role="form" action="/oauth/login" method="post">
                    ...
                    <div style="margin-top:10px" class="form-group">
                        ...
                        <div class="col-sm-12 controls">
                            ...
                            <a id="btn-fblogin" href="#" class="btn btn-primary hide">Login with Facebook</a>
...
<script type="application/javascript" src="/src/external/components/webmodules-bootstrap/js/bootstrap.min.js"></script>
</html>
